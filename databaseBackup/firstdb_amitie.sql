...
CREATE TABLE `amitie` (
  `id` int NOT NULL,
  `utilisateur_id_1` int DEFAULT NULL,
  `utilisateur_id_2` int DEFAULT NULL,
  `date_amitie` date DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `utilisateur_id_1` (`utilisateur_id_1`),
  KEY `utilisateur_id_2` (`utilisateur_id_2`),
  CONSTRAINT `amitie_ibfk_1` FOREIGN KEY (`utilisateur_id_1`) REFERENCES `utilisateur` (`id`),
  CONSTRAINT `amitie_ibfk_2` FOREIGN KEY (`utilisateur_id_2`) REFERENCES `utilisateur` (`id`)
